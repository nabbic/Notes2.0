...
namespace wmgCMS
{
    public class WaterMarkTextBox : TextBox
    {
        ...
        #region Attributes
        public Color _waterMarkColor = Color.Gray;
        ...
        public string _waterMarkText = "Water Mark";
        ...
        public void JoinEvents(Boolean join)
        {
            if (join)
            {
        ...
        public void WaterMark_FontChanged(object sender, EventArgs args)
        {
